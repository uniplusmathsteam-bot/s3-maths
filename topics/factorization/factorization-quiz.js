...
(function () {
  ...
  const QUIZ_L01 = [
    ...
    },
    {
      id: 5,
      type: "mc",
      prompt: "A rectangle has area 3x^2 + 11x + 6 cm^2 and length 3x + 2 cm. Which expression represents its width?",
      choices: [
        "x + 1\\text{ cm}",
        "x + 2\\text{ cm}",
        "x + 3\\text{ cm}",
